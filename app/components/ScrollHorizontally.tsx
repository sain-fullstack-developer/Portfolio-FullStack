		...
		<div className="overflow-hidden flex">
			<div className="overflow-hidden">
				<div
					id="skills"
					ref={scroller}
					className="flex overflow-x-hidden text-white w-[1200vw] m-0 bg-[#ab8b74] relative h-full md:h-screen">
					<motion.section
						ref={skills}
					...
					<section
						...
						<div className="text-center sm:text-left bg-primary p-6 text-gray-900 w-[90%] grid place-items-center">
					...
					<section
						ref={skills}
						className="skill-set px-12 w-screen h-full bg-transparent ns-horizontal-section__item flex justify-center items-center z-50">
						<div className="text-center sm:text-left bg-primary p-6 text-gray-900 w-[80%] grid place-items-center">
							<motion.div
								initial={{
									opacity: 0,
									y: 10,
					...
					<section
						ref={skills}
						className="skill-set px-12 w-screen h-full bg-transparent ns-horizontal-section__item flex justify-center items-center z-50">
						<div className="text-center sm:text-left bg-primary p-6 text-gray-900 w-[60%] grid place-items-center">
							<h1 className="text-8xl text-center py-6">Projects</h1>
						</div>
					</section>
					...
					{projectsData.map((project, index) => {
						return (
							<section
								...
								ref={skills}
								className="skill-set px-12 w-screen h-full bg-transparent ns-horizontal-section__item flex justify-center items-center z-50">
								<div className="text-center sm:text-left bg-primary p-6 text-gray-900 w-[90%] md:h-[90%]">
									<h1 className="text-8xl text-center">{`Project-${
										index + 1
									}`}</h1>
									<ProjectCard
										title={project?.title}
